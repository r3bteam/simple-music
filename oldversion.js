...
//         client.user.setActivity(`m-play | ${client.guilds.size} servers`, {type: "LISTENING"})
...
// 		if (!message.member.voiceChannel || guilds[message.guild.id].voiceChannel != null) return message.reply(novc);
